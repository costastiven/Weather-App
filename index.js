const apiKey = 'cf2095a188b31758adde40833fac805f';
...
// Mapeo de códigos de condiciones climáticas a nombres de clases de íconos (según la respuesta de Openweather Api)
...
function fetchWeatherData(location) {
    ...
    // Construyendo la URL de API con la ubicación y la clave de API
    ...
    fetch(apiUrl).then(response => response.json()).then(data => {
        ...
        // Actualiza la ubicación y la descripción del clima en la sección "información de la izquierda"
        ...
        for (const dayData of nextDaysData) {
            ...
            // Asegúrese de que el día no esté duplicado y hoy
            ...
            // Deténgase después de 4 días distintos
            if (count === 4) break;
        }
    }).catch(error => {
...
// Obtener datos meteorológicos al cargar documentos para la ubicación predeterminada (Alemania)
